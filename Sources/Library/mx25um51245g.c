...
/**
  ...
  * @retval error status
  */
int32_t MX25UM51245G_WriteStatusRegister(XSPI_HandleTypeDef *Ctx, MX25UM51245G_Interface_t Mode,
                                         MX25UM51245G_Transfer_t Rate, uint8_t Value)
{
  XSPI_RegularCmdTypeDef s_command = {0};
  uint8_t reg[2];
  ...
  if (Mode == MX25UM51245G_SPI_MODE)
  {
    if (MX25UM51245G_ReadCfgRegister(Ctx, Mode, Rate, &reg[1]) != MX25UM51245G_OK)
    {
      return MX25UM51245G_ERROR;
    }
  }
  ...
  s_command.InstructionWidth   = (Mode == MX25UM51245G_SPI_MODE)
                                 ...
                                 : HAL_XSPI_INSTRUCTION_16_BITS;
  s_command.Instruction        = (Mode == MX25UM51245G_SPI_MODE)
                                 ? MX25UM51245G_WRITE_STATUS_REG_CMD
                                 : MX25UM51245G_OCTA_WRITE_STATUS_REG_CMD;
  s_command.AddressMode        = (Mode == MX25UM51245G_SPI_MODE) ? HAL_XSPI_ADDRESS_NONE : HAL_XSPI_ADDRESS_8_LINES;
  s_command.AddressDTRMode     = (Rate == MX25UM51245G_DTR_TRANSFER)
                                 ? HAL_XSPI_ADDRESS_DTR_ENABLE
                                 : HAL_XSPI_ADDRESS_DTR_DISABLE;
  ...
  s_command.DataDTRMode        = (Rate == MX25UM51245G_DTR_TRANSFER)
                                 ...
                                 : HAL_XSPI_DATA_DTR_DISABLE;
  s_command.DummyCycles        = 0U;
  s_command.DataLength             = (Mode == MX25UM51245G_SPI_MODE) ? 2U : ((Rate == MX25UM51245G_DTR_TRANSFER) ? 2U : 1U);
  s_command.DQSMode            = HAL_XSPI_DQS_DISABLE;
  s_command.SIOOMode           = HAL_XSPI_SIOO_INST_EVERY_CMD;
...
/**
  ...
  * @retval error status
  */
int32_t MX25UM51245G_WriteCfgRegister(XSPI_HandleTypeDef *Ctx, MX25UM51245G_Interface_t Mode,
                                      MX25UM51245G_Transfer_t Rate, uint8_t Value)
{
  XSPI_RegularCmdTypeDef s_command = {0};
  uint8_t reg[2];
  ...
  if (Mode == MX25UM51245G_SPI_MODE)
  {
    if (MX25UM51245G_ReadStatusRegister(Ctx, Mode, Rate, &reg[0]) != MX25UM51245G_OK)
    {
      return MX25UM51245G_ERROR;
    }
    reg[1] = Value;
...
/**
  ...
  * @retval error status
  */
int32_t MX25UM51245G_ReadCfgRegister(XSPI_HandleTypeDef *Ctx, MX25UM51245G_Interface_t Mode,
                                     MX25UM51245G_Transfer_t Rate, uint8_t *Value)
{
  XSPI_RegularCmdTypeDef s_command = {0};
  ...
  s_command.InstructionWidth   = (Mode == MX25UM51245G_SPI_MODE)
                                 ...
                                 : HAL_XSPI_INSTRUCTION_16_BITS;
  s_command.Instruction        = (Mode == MX25UM51245G_SPI_MODE)
                                 ? MX25UM51245G_READ_CFG_REG_CMD
                                 : MX25UM51245G_OCTA_READ_CFG_REG_CMD;
  s_command.AddressMode        = (Mode == MX25UM51245G_SPI_MODE) ? HAL_XSPI_ADDRESS_NONE : HAL_XSPI_ADDRESS_8_LINES;
  s_command.AddressDTRMode     = (Rate == MX25UM51245G_DTR_TRANSFER)
                                 ? HAL_XSPI_ADDRESS_DTR_ENABLE
                                 : HAL_XSPI_ADDRESS_DTR_DISABLE;
...
/**
  ...
  * @retval error status
  */
int32_t MX25UM51245G_WriteSecurityRegister(XSPI_HandleTypeDef *Ctx, MX25UM51245G_Interface_t Mode,
                                           MX25UM51245G_Transfer_t Rate, uint8_t Value)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(Value);
  ...
  s_command.InstructionWidth   = (Mode == MX25UM51245G_SPI_MODE)
                                 ...
                                 : HAL_XSPI_INSTRUCTION_16_BITS;
  s_command.Instruction        = (Mode == MX25UM51245G_SPI_MODE)
                                 ? MX25UM51245G_WRITE_SECURITY_REG_CMD
                                 : MX25UM51245G_OCTA_WRITE_SECURITY_REG_CMD;
  s_command.AddressMode        = HAL_XSPI_ADDRESS_NONE;
  s_command.AlternateBytesMode = HAL_XSPI_ALT_BYTES_NONE;
  s_command.DataMode           = HAL_XSPI_DATA_NONE;
  s_command.DummyCycles        = 0U;
...
/**
  ...
  * @retval error status
  */
int32_t MX25UM51245G_ReadSecurityRegister(XSPI_HandleTypeDef *Ctx, MX25UM51245G_Interface_t Mode,
                                          MX25UM51245G_Transfer_t Rate, uint8_t *Value)
{
  XSPI_RegularCmdTypeDef s_command = {0};
  ...
  s_command.InstructionWidth   = (Mode == MX25UM51245G_SPI_MODE)
                                 ...
                                 : HAL_XSPI_INSTRUCTION_16_BITS;
  s_command.Instruction        = (Mode == MX25UM51245G_SPI_MODE)
                                 ? MX25UM51245G_READ_SECURITY_REG_CMD
                                 : MX25UM51245G_OCTA_READ_SECURITY_REG_CMD;
  s_command.AddressMode        = (Mode == MX25UM51245G_SPI_MODE) ? HAL_XSPI_ADDRESS_NONE : HAL_XSPI_ADDRESS_8_LINES;
  s_command.AddressDTRMode     = (Rate == MX25UM51245G_DTR_TRANSFER)
                                 ? HAL_XSPI_ADDRESS_DTR_ENABLE
                                 : HAL_XSPI_ADDRESS_DTR_DISABLE;
...
/**
  ...
  * @retval error status
  */
int32_t MX25UM51245G_ReadID(XSPI_HandleTypeDef *Ctx, MX25UM51245G_Interface_t Mode, MX25UM51245G_Transfer_t Rate,
                            uint8_t *ID)
{
  XSPI_RegularCmdTypeDef s_command = {0};
  ...
  s_command.InstructionWidth   = (Mode == MX25UM51245G_SPI_MODE)
                                 ...
                                 : HAL_XSPI_INSTRUCTION_16_BITS;
  s_command.Instruction        = (Mode == MX25UM51245G_SPI_MODE)
                                 ? MX25UM51245G_READ_ID_CMD
                                 : MX25UM51245G_OCTA_READ_ID_CMD;
  s_command.AddressMode        = (Mode == MX25UM51245G_SPI_MODE)
...
/**
  ...
  * @retval error status
  */
int32_t MX25UM51245G_NoOperation(XSPI_HandleTypeDef *Ctx, MX25UM51245G_Interface_t Mode, MX25UM51245G_Transfer_t Rate)
{
  XSPI_RegularCmdTypeDef s_command = {0};
  ...
  s_command.InstructionWidth   = (Mode == MX25UM51245G_SPI_MODE)
                                 ? HAL_XSPI_INSTRUCTION_8_BITS
                                 : HAL_XSPI_INSTRUCTION_16_BITS;
  s_command.Instruction        = (Mode == MX25UM51245G_SPI_MODE) ? MX25UM51245G_NOP_CMD : MX25UM51245G_OCTA_NOP_CMD;
  s_command.AddressMode        = HAL_XSPI_ADDRESS_NONE;
  s_command.AlternateBytesMode = HAL_XSPI_ALT_BYTES_NONE;
  s_command.DataMode           = HAL_XSPI_DATA_NONE;
  s_command.DummyCycles        = 0U;
...
/**
  ...
  * @retval error status
  */
int32_t MX25UM51245G_EnterPowerDown(XSPI_HandleTypeDef *Ctx, MX25UM51245G_Interface_t Mode,
                                    MX25UM51245G_Transfer_t Rate)
{
  XSPI_RegularCmdTypeDef s_command = {0};
  ...
  s_command.InstructionWidth   = (Mode == MX25UM51245G_SPI_MODE)
                                 ...
                                 : HAL_XSPI_INSTRUCTION_16_BITS;
  s_command.Instruction        = (Mode == MX25UM51245G_SPI_MODE)
                                 ? MX25UM51245G_ENTER_DEEP_POWER_DOWN_CMD
                                 : MX25UM51245G_OCTA_ENTER_DEEP_POWER_DOWN_CMD;
  s_command.AddressMode        = HAL_XSPI_ADDRESS_NONE;
  s_command.AlternateBytesMode = HAL_XSPI_ALT_BYTES_NONE;
  s_command.DataMode           = HAL_XSPI_DATA_NONE;
  s_command.DummyCycles        = 0U;
