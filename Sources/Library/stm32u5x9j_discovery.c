/**
  ******************************************************************************
  * @file    stm32u5x9j_discovery.c
  * @author  MCD Application Team
  * @brief   This file provides a set of firmware functions to manage
  *          LEDs
  *          USER push-button
  *          COM port
  *          available on STM32U5x9J_DISCOVERY board(MB1829) from STMicroelectronics.
  ******************************************************************************
  * @attention
  *
...
/** @defgroup STM32U5x9J_DISCOVERY_LOW_LEVEL LOW LEVEL
  * @{
  */
...
/** @defgroup STM32U5x9J_DISCOVERY_LOW_LEVEL_Private_TypesDefinitions LOW LEVEL Private Types Definitions
  * @{
  */
...
/** @defgroup STM32U5x9J_DISCOVERY_LOW_LEVEL_Private_FunctionPrototypes  LOW LEVEL Private Function Prototypes
  * @{
  */
// static void BUTTON_USER_EXTI_Callback(void);
// #if (USE_BSP_COM_FEATURE > 0)
// // static void COM_MspInit(const UART_HandleTypeDef *huart);
// // static void COM_MspDeInit(const UART_HandleTypeDef *huart);
...
/** @defgroup STM32U5x9J_DISCOVERY_LOW_LEVEL_Private_Variables LOW LEVEL Private Variables
  * @{
  */
...
/**
  * @brief  This method returns the STM32U5x9J_DISCOVERY BSP Driver revision
  * @retval version: 0xXYZR (8bits for each decimal, R for RC)
  */
int32_t BSP_GetVersion(void)
{
  return (int32_t)STM32U5x9J_DISCOVERY_BSP_VERSION;
}
...
{
  return (uint8_t *)STM32U5x9J_DISCOVERY_BSP_BOARD_NAME;
}
...
{
  return (uint8_t *)STM32U5x9J_DISCOVERY_BSP_BOARD_ID;
}
