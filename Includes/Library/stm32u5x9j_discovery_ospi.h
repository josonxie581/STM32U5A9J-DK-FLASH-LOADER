/**
  ******************************************************************************
  * @file    stm32u5x9j_discovery_ospi.h
  * @author  MCD Application Team
  * @brief   This file contains the common defines and functions prototypes for
  *          the stm32u5x9j_discovery_ospi.c driver.
  ******************************************************************************
  * @attention
  *
...
#ifndef STM32U5x9J_DISCOVERY_OSPI_H
#define STM32U5x9J_DISCOVERY_OSPI_H
...
/** @addtogroup STM32U5x9J_DISCOVERY_OSPI
  * @{
  */

/* Exported types ------------------------------------------------------------*/
/** @defgroup STM32U5x9J_DISCOVERY_OSPI_Exported_Types OSPI Exported Types
  * @{
  */
typedef enum
{
...
#define BSP_OSPI_NOR_SPI_MODE       (BSP_OSPI_NOR_Interface_t)MX25UM51245G_SPI_MODE /* 1 Cmd Line, 1 Address Line
                                                                                       and 1 Data Line    */
#define BSP_OSPI_NOR_OPI_MODE       (BSP_OSPI_NOR_Interface_t)MX25UM51245G_OPI_MODE /* 8 Cmd Lines, 8 Address Lines
                                                                                         and 8 Data Lines */

/* Definition for OSPI transfer rates */
#define BSP_OSPI_NOR_STR_TRANSFER   (BSP_OSPI_NOR_Transfer_t)MX25UM51245G_STR_TRANSFER   /* Single Transfer Rate */
#define BSP_OSPI_NOR_DTR_TRANSFER   (BSP_OSPI_NOR_Transfer_t)MX25UM51245G_DTR_TRANSFER   /* Double Transfer Rate */
...
#endif /* STM32U5x9J_DISCOVERY_OSPI_H */
